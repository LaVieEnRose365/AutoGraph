...
def parse_args():
    ...
    parser.add_argument("--plus_lightgcn_embed", action="store_true")
    parser.add_argument("--plus_ccgnn_embed", action="store_true")
    parser.add_argument("--plus_topoI2I_embed", action="store_true")
