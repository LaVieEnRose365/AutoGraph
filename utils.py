...
def get_metric():
    ...
    metrics = []
    r = f"./outputs/{dataset}/{match_model}/42/"
...
def parse_args():
    ...
    parser.add_argument("--quant_dir", type=str, default="outputs_quant")
    ...
    parser.add_argument("--num_quantizers", type=str, default="3|3", help="user|item")
    parser.add_argument("--codebook_size", type=str, default="300|256", help="user|item")
